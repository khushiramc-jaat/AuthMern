...
const Register = () => {
    ...
    const addUserdata =async(e)=>{
        ...
        if(fname ==""){
            ...
            alert("password and conofirm password not match");
        }
        else{
            console.log("user registration succesful done");
    ...
    <section>
        <div className="form_data">
            <div className="form_heading">
                ...
                <p style={{textAlign:"center"}}>We glad that you will be using Project Cloud to manage<br/> your tasks! We hope that you will get like ie.</p>
            </div>
